...
def load_data(filename):
    ...
    with open(filename, "r") as f:
        ...
        for row in reader:
            ...
            evidence.append(1 if row['VisitorType'] == 'returning visitors' else 0)
...
def evaluate(labels, predictions):
    ...
    """
    true_positive_labels, true_negative_labels, false_positive_labels, false_negative_labels = 0, 0, 0, 0
    ...
    if negative_labels == 0:
        negative_labels = 1
    return (true_positive_labels / positive_labels, true_negative_labels / negative_labels)
